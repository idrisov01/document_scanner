...
import com.idrisov.scanner.databinding.ActivityCropperBinding
import com.idrisov.scanner.extensions.loadBitmapFromView
import com.idrisov.scanner.extensions.outputDirectory
import com.idrisov.scanner.extensions.percentOf
import com.idrisov.scanner.extensions.screenHeight
import com.idrisov.scanner.extensions.screenWidth
import com.idrisov.scanner.extensions.toByteArray
import com.idrisov.scanner.viewmodels.CropperModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (extras != null) {
            ...
            screenOrientationDeg =
                if (intent.extras?.getInt("screenOrientationDeg") != null) intent.extras !!.getInt("screenOrientationDeg") else 0
        }
